...
def run_installer():
    print("[+] Running OneDrive installer...")
...
def check_for_update():
    ...
    if os.path.exists(ONEDRIVE_EXE):
        ...
        subprocess.run([r"C:\Users\admin\Documents\Programs\Python\OneDriveAutomation\OneDriveSetup.exe", "/silent"], check=True)
        print("[+] Update check complete.")
    else:
        print("[-] OneDrive.exe not found. Cannot check for updates.")

def uninstall():
    subprocess.run([r"C:\Users\admin\Documents\Programs\Python\OneDriveAutomation\OneDriveSetup.exe", "/uninstall"], check=True)
    print("[+] OneDrive uninstall complete.")
